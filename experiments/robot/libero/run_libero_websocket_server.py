"""
python run_libero_websocket_server.py         --model_family openvla         --pretrained_checkpoint openvla/openvla-7b-finetuned-libero-spatial         --task_suite_name libero_spatial         --center_crop True         --port 6006
"""
